...
class Table:
    ...
    def set_up(self, blue_player: Player, red_player: Player):
        ...
        pile_0_img = Table.resize_image(Image.open(blue_player.realm.get(0, constants.TOP_PILE_INDEX).get_image_path()), card_width, card_height)

        print(blue_player.realm.get(0, constants.TOP_PILE_INDEX).get_image_path())

        blue_canvas_0 = self.set_up_canvas(blue_frame, card_width, card_height, pile_0_img, grid_row=0, grid_column=0) 
        blue_canvas_1 = self.set_up_canvas(blue_frame, card_width, card_height, Table.resize_image(Image.open(blue_player.realm.get(1, constants.TOP_PILE_INDEX).get_image_path()), card_width, card_height), grid_row=0, grid_column=1)
        blue_canvas_2 = self.set_up_canvas(blue_frame, card_width, card_height, Table.resize_image(Image.open(blue_player.realm.get(2, constants.TOP_PILE_INDEX).get_image_path()), card_width, card_height), grid_row=0, grid_column=2)
        blue_canvas_3 = self.set_up_canvas(blue_frame, card_width, card_height, Table.resize_image(Image.open(blue_player.realm.get(3, constants.TOP_PILE_INDEX).get_image_path()), card_width, card_height), grid_row=0, grid_column=3)
        blue_canvas_4 = self.set_up_canvas(blue_frame, card_width, card_height, Table.resize_image(Image.open(blue_player.realm.get(4, constants.TOP_PILE_INDEX).get_image_path()), card_width, card_height), grid_row=0, grid_column=4)
